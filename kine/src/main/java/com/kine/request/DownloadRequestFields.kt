...
import java.util.concurrent.Executor
 ...
 class DownloadRequestFields(val file: File, val progressListener:ProgressListener, kineClient: KineClient?,
                             converter: Converter?, requestDataFields: RequestDataFields, priority: Priority, retryPolicy: RetryPolicy?,
